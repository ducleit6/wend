...
<head>
  ...
  <link rel="stylesheet" href="{{ url('public/project') }}/css/loginn.css">
  @yield('css')
</head>
  <body>
                            ...
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <a class="dropdown-item" href="{{route('home.tourpagkages')}}">Tour Pagkages</a>
                                    </div>
                                </li>
                                <li class="nav-item">
    ...
    <div class="login-box"> 
        ...
        @csrf
            ...
            <a href="{{route('home-register')}}"><span></span><span></span><span></span><span></span>Đăng Ký</a>
            <a href="{{route('home')}}"><span></span><span></span><span></span><span></span>Back</a>
        </form>
    </div>
