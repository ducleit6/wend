        ...
        <form action="" method="GET" class="form-inline">
            ...
            <div class="form-group ml-auto">
                <a href="{{route('category.forcedeleteAll')}}" class="btn btn-danger btn-delete-all  mr-1"><i class="fas fa-trash mr-1"></i>Xóa
                    Lựa
                    chọn</a>
                    <a href="{{route('category.restoreAll')}}" class="btn btn-warning btn-restore-all  mr-1"><i class="fas fa-window-restore mr-1"></i>Khôi phục
                    Lựa
                    chọn</a>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{route('category.restore',$data->id)}}" class="btn btn-warning mr-1">
