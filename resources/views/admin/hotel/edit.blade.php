...
<div class="col-6">
    <div class="card">
        <div class="card-body">
            <form method="POST" class="form-horizontal" action="{{route('hotel.update',$data->id)}}"
                ...
                <div class="card-body mb-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="destination_id" id="catid" class="form-control mt-1" style="margin-top:-9px">
                                ...
                                <option value="{{$des->id}}" {{$data->destination_id == $des->id?'selected':''}}>{{$des->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label for="desname" class="form-label">Tên Khách sạn</label>
