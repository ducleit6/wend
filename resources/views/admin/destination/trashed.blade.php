    ...
    <div class="card-body">
        ...
        <form action="" method="GET" class="form-inline">
            ...
            <div class="form-group ml-auto">
                <a href="{{route('destination.forcedeleteAll')}}" class="btn btn-danger btn-delete-all  mr-1"><i class="fas fa-trash mr-1"></i>Xóa
                    Lựa
                    chọn</a>
                    <a href="{{route('destination.restoreAll')}}" class="btn btn-warning btn-restore-all  mr-1"><i class="fas fa-window-restore mr-1"></i>Khôi phục
                    Lựa
                    chọn</a>
                <a href="{{route('destination.index')}}" class="btn btn-primary ml-auto"><i class="fas fa-arrow-circle-left mr-1"></i>Danh sách</a>
            </div>
        </form>
        <hr>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{route('destination.restore',$data->id)}}" class="btn btn-warning mr-1">
                            <i class="fas fa-window-restore"></i>
                            </a>
                            <a href="{{route('destination.forceDelete',$data->id)}}"
