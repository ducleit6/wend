        ...
        <form action="" method="GET" class="form-inline">
            ...
            <div class="form-group ml-auto">
                <button type="button" class="btn btn-danger btn-delete-all  mr-1"><i class="fas fa-trash mr-1"></i>Xóa
                    Lựa
                    chọn</button>
                <a href="{{route('destination.create')}}" class="btn btn-primary ml-auto"><i
                        class="far fa-plus-square mr-1"></i>Thêm mới</a>
            </div>
        </form>
        <hr>
        <form action="{{route('destination.deleteAll')}}" method="POST" id="form-delete-all">
            @csrf @method('DELETE')
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{route('destination.edit',$data->id)}}" class="btn btn-warning mr-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="{{route('destination.delete',$data->id)}}"
