...
@section('title','Sửa Chuyến du lịch')
@section('main')



<hr>
<form method="POST" class="form-horizontal" action="{{route('tour.update',$data->id)}}" enctype="multipart/form-data">
    @csrf @method('PUT')
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="arrtist_id" name="sale_price" placeholder="Nhập ..."
                            value="{{old('sale_price')?old('sale_price'):$data->sale_price}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="arrtist_id" name="max_member" placeholder="Nhập ..."
                            value="{{old('max_member')?old('max_member'):$data->max_member}}">
                        <!-- @error('sale_price') <small style="color:red;"><i>{{$message}}</i></small>@enderror -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="arrtist_id" name="min_member" placeholder="Nhập ..."
                            value="{{old('min_member')?old('min_member'):$data->min_member}}">
                        <!-- @error('sale_price') <small style="color:red;"><i>{{$message}}</i></small>@enderror -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="arrtist_id" name="start_day" placeholder="Nhập ..."
                            value="{{old('date')?old('date'):$data->date}}">
                        <!-- @error('sale_price') <small style="color:red;"><i>{{$message}}</i></small>@enderror -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 " name="destination_id" 
                            ...
                            <option data-select2-id="{{$des->id}}" value="{{$des->id}}" {{$data->destination_id==$des->id?'selected':''}}>{{$des->name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{asset('public/uploads').'/'.$data->image}}" class="mt-2" id="show_img" width="100%">
