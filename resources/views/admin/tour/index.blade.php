...
@section('title','Danh sách Chuyến du lịch')
@section('main')
<div class="card">
    <div class="card-body">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>Lượng người tối đa</th>
                        <th>Lượng người tối thiểu</th>
                        <th>Trạng thái</th>
                ...
                <tbody>
                    @if($datas->count() == 0)
                    <tr>
                        <td colspan="13" class="text-center">Hiện tại chưa có Chuyến du lịch nào</td>
                    </tr>
                    @else
                    ...
                    <tr>
                        ...
                        <td>{{$data->id}}</td>
                        <td>{{$data->name}}</td>
                        <td><img src="{{url('public/uploads/').'/'.$data->image}}" width="60" alt=""></td>
                        <td>{{$data->destinations->name}}</td>
                        <td>{{$data->price}}</td>
                        ...
                        <td class="text-right">
                            ...
                            <a href="{{route('tour.delete',$data->id)}}"
