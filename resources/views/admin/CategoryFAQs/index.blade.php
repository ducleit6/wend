...
<form action="" method="get" class="form-inline" role="form">
    ...
    <a href="{{route('CategoryFAQs.create')}}" class="btn btn-warning ml-2"><i class="fas fa-plus"></i> Thêm mới</a>
</form>
    ...
    <tbody>
        @foreach($data as $FAQs)
            <tr>
                ...
                <td>
                    <form action="{{route('CategoryFAQs.delete', $FAQs->id)}}" method="post">
                        @csrf @method('delete')
                        <a href="{{route('CategoryFAQs.edit', $FAQs->id)}}" class="btn btn-sm btn-primary">Sửa</a>
